function showOffers(offersOnClientSide, counter, direction) {
  ...
  if (clientSideResults.length && window.location.href.indexOf("books?") > -1 || clientSideResults.length && window.location.href.indexOf("modify") > -1) {
  ...
  if (clientSideResults.length && window.location.href.indexOf("books?login") > -1 || clientSideResults.length && window.location.href.indexOf("modify") > -1) {
